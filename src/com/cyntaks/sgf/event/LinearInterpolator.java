...
public class LinearInterpolator implements Interpolator, Serializable
{
  ...
  public LinearInterpolator(float startValue, float midValue, float endValue)
  {
  ...
  public LinearInterpolator(float startValue, float midValue1, float midValue2, float endValue)
  {
